(function (module) {
	...
	module.controller('RegisterCtrl', ['$scope','Local','$state','$rootScope','$http','CONSTANTS', function ($scope,Local,$state,$rootScope,$http,CONSTANTS) {
		...
		$scope.cadastrarse = function(obj){
			...
			if($scope.registro.$valid && obj.senha === obj.senha2){
				...
				$http({
					url: CONSTANTS.API_HOST + '/create-user',
					method: "POST",
					data: obj 
				})
